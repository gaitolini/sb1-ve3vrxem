    ...
    <form onSubmit={handleSubmit} className="space-y-6">
      <div>
        ...
        <input
          ...
          required
          className="mt-1 block w-full rounded-md border-gray-300 bg-white dark:bg-gray-800 shadow-sm focus:border-blue-500 focus:ring-blue-500 dark:border-gray-600 dark:text-white"
        />
      </div>
      <div>
